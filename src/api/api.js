...
export const getMovies = async (page = 1,genreforURL,sort_by ='popularity.desc') =>{
...
export const getSeries = async (page = 1,genreforURL,sort_by ='popularity.desc') =>{
...
export const toSearch = async(type,searchQuery,page=1 ) => {
